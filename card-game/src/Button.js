    ...
    return (
        <div>
            ...
            <div id={props.isWar ? "showWar" : "invisible" }>
                <img src={require(`${userCards[3].img}`)} className="warcard1" id={props.isWar ? "usercardwar4" : "invisible" } alt="" />
                <img src={require(`${compCards[3].img}`)} className="warcard1" id={props.isWar ? "compcardwar4" : "invisible" } alt="" />
            </div>
        </div>
        )
}
